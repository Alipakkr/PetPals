...
export const Contact = () => {
  return (
    <div name='contact' className="w-full h-screen bg-gradient-to-b to-stone-00 from-fuchsia-100 p-4 text-black">
        ...
        <div className="flex justify-center items-center">
          <form action="https://getform.io/f/5ee09b04-750a-4561-a005-318ea9e9ff91" method="POST"className="flex flex-col w-full md:w-1/2">
            ...
            <input
              ...
              required
            />
            <textarea name="message" placeholder="Enter your massage" rows="10" className="p-2 bg-transparent border-2 rounded-md text-black focus:outline-none"></textarea>
